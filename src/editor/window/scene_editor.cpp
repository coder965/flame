...
{
	if (ImGui::Begin("scene", &opened, ImGuiWindowFlags_NoScrollbar | ImGuiWindowFlags_NoScrollWithMouse))
	{
		auto size = ImGui::GetWindowContentRegionMax() - ImGui::GetWindowContentRegionMin();
		//size -= ImGui::GetStyle().WindowPadding * 2 - ImGui::GetStyle(). - ImVec2(1, 1);
