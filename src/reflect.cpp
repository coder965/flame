...
currentBank->addV<std::string>("pipelineName", offsetof(ShaderMacro, pipelineName));
currentBank->addE("StageType", "stageType", offsetof(ShaderMacro, stageType));
...
currentBank->addE("VertexInputType", "vertex_input_type", offsetof(PipelineArchive, vertex_input_type));
