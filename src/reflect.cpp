...
tke::ReflectionBank *StageArchive::b = tke::addReflectionBank("StageArchive");
tke::ReflectionBank *LinkResource::b = tke::addReflectionBank("LinkResource");
tke::ReflectionBank *PipelineArchive::b = tke::addReflectionBank("PipelineArchive");
...
currentBank = StageArchive::b;
currentBank->addV<std::string>("filename", offsetof(StageArchive, filename));
...
currentBank = PipelineArchive::b;
currentBank->addV<std::string>("name", offsetof(PipelineArchive, name));
currentBank->addV<int>("cx", offsetof(PipelineArchive, cx));
currentBank->addV<int>("cy", offsetof(PipelineArchive, cy));
currentBank->addV<int>("patch_control_points", offsetof(PipelineArchive, patch_control_points));
currentBank->addV<bool>("depth_test", offsetof(PipelineArchive, depth_test));
currentBank->addV<bool>("depth_write", offsetof(PipelineArchive, depth_write));
currentBank->addV<bool>("depth_clamp", offsetof(PipelineArchive, depth_clamp));
currentBank->addE("PrimitiveTopology", "primitive_topology", offsetof(PipelineArchive, primitive_topology));
currentBank->addE("PolygonMode", "polygon_mode", offsetof(PipelineArchive, polygon_mode));
currentBank->addE("CullMode", "cull_mode", offsetof(PipelineArchive, cull_mode));
...
currentBank->addE("Format", "format", offsetof(ImageResource, format));
