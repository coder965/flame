...
currentBank = Model::b;
currentBank->addV<std::string>("stand_animation_name", offsetof(Model, stand_animation_name));
currentBank->addV<std::string>("forward_animation_name", offsetof(Model, forward_animation_name));
currentBank->addV<std::string>("left_animation_name", offsetof(Model, left_animation_name));
currentBank->addV<std::string>("right_animation_name", offsetof(Model, right_animation_name));
currentBank->addV<std::string>("backward_animation_name", offsetof(Model, backward_animation_name));
currentBank->addV<std::string>("jump_animation_name", offsetof(Model, jump_animation_name));
