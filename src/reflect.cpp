...
VkPipelineVertexInputStateCreateInfo null_vertex_input_state;
...
currentBank->addV<glm::vec3>("coord", offsetof(Controller, coord));
currentBank->addV<glm::vec3>("euler", offsetof(Controller, euler));
currentBank->addV<glm::vec3>("scale", offsetof(Controller, scale));
...
currentBank->addV<bool>("enable_physics", offsetof(Terrain, enable_physics));
