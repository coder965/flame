...
currentBank->addE("StageFlags", "stage", offsetof(Descriptor, stage));
...
currentBank->addV<int>("patchControlPoints", offsetof(PipelineAbstract, patchControlPoints));
currentBank->addV<bool>("depthTest", offsetof(PipelineAbstract, depthTest));
currentBank->addV<bool>("depthWrite", offsetof(PipelineAbstract, depthWrite));
currentBank->addV<bool>("depthClamp", offsetof(PipelineAbstract, depthClamp));
